...
from home.models import Author, BookInstance, Book, Genre
from home.views import AuthorCreate
...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location(self):
        response = self.client.get('/home/authors/')
    ...
    def test_view_uses_correct_template(self):
        response = self.client.get(reverse('authors'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'home/author_list.html')
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_book.genre.set(
            genre_objects_for_book)  # Direct assignment of many-to-many types not allowed.
        test_book.save()
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response,
                             '/accounts/login/?next=/home/mybooks/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response,
                                'home/bookinstance_list_borrowed_user.html')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        # Check we used correct template
        self.assertTemplateUsed(response, 'home/book_renew_librarian.html')
...
class AuthorCreateTest(TestCase):
    ...
    def test_correct_initial_date(self):
        login = self.client.login(username='testuser2',
                                  password='2HJ1vRV0Z&3iD')
    ...
    def test_ok_if_logged_in_with_correct_permission(self):
        login = self.client.login(username='testuser2',
                                  password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_uses_correct_template(self):
        ...
        # Check we used correct template
        self.assertTemplateUsed(response, 'home/author_form.html')

    def test_redirect_if_not_logged_in(self):
        response = self.client.get(reverse('author-create'))
        self.assertRedirects(response,
                             '/accounts/login/?next=/home/authors/create/')

    def test_redirects_to_author_detail_view_on_success(self):
        login = self.client.login(username='testuser2',
                                  password='2HJ1vRV0Z&3iD')
        ...
        self.assertEqual(response.status_code, 302)
        self.assertTrue(response.url.startswith('/home/authors/'))
